    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div style={{
            width: 52, height: 52, borderRadius: 14, background: "var(--brand-500)",
            display: "flex", alignItems: "center", justifyContent: "center",
            margin: "0 auto 16px", fontSize: 24,
          }}>🏦</div>
          <h1 style={{ fontSize: "1.375rem", fontWeight: 700, letterSpacing: "-0.02em" }}>Sign in to NovaBanк</h1>
        ...
        <div className="card" style={{ padding: "32px" }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: "0.8125rem", color: "var(--text-brand)", fontWeight: 500, marginBottom: 2 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <a href="#" style={{ fontSize: "0.8rem", color: "var(--text-brand)", textDecoration: "none" }}>
                  Forgot password?
                </a>
              </div>
              <input
            ...
            {error && (
              <div style={{
                padding: "10px 14px", background: "var(--error-50)",
                borderRadius: "var(--radius-md)", fontSize: "0.875rem", color: "var(--error-700)",
              }}>
                {error}
              </div>
            )}
