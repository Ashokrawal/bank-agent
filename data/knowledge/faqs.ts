 ...
 * NovaBank - FAQ knowledge base for ChromaDB RAG
 *
...
export const FAQ_DATA: FAQEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. NovaBank joint accounts work for two people. Both account holders complete identity verification separately - each receives a verification link by email. Both can transact freely on the account. Either holder can freeze the card, but closing the account requires consent from both. Joint accounts are protected up to £170,000 under the FSCS scheme.",
    category: "accounts",
  },
  {
    id: "faq-005",
    question: "Can I have more than one account with NovaBank?",
    answer:
  ...
  },
  {
    ...
    answer:
      "A Cash ISA is a tax-free savings account. You can deposit up to £20,000 per tax year. Interest earned is completely free of UK income tax. NovaBank Cash ISA pays 4.6% AER. You can transfer existing ISAs from other providers to NovaBank without using your annual allowance. Withdrawals are allowed but in a flexible ISA you can replace what you withdraw in the same tax year.",
    category: "savings",
  },
  {
    id: "faq-009",
    ...
    answer:
      "No. NovaBank fixed-rate bonds do not allow early withdrawals during the fixed term. Your money is locked in for the full 1 or 2 year period. In exchange you get a guaranteed rate that will not change regardless of what happens to interest rates. If you need access to your money, choose the Easy Access Saver instead at 4.5% AER.",
    category: "savings",
  },
  ...
  },
  {
    ...
    answer:
      "Yes, NovaBank lends to self-employed applicants. You need at least 2 years of self-employment history with SA302 tax calculations and tax year overviews from HMRC. We also need 2 years of certified accounts prepared by a qualified accountant. The application process is the same as employed applicants. A specialist self-employed mortgage adviser will handle your case - book through the chat assistant.",
    category: "mortgages",
  },
  {
    id: "faq-012",
  ...
  },
  {
    ...
    answer:
      "NovaBank personal loans range from £1,000 to £25,000 over 1 to 7 years. Representative APR is 6.9% for loans between £7,500 and £25,000. Smaller loans have higher APR. Apply in the app or chat - you get an instant decision. Funds arrive in your account the same day if approved before 3pm. Early repayment is allowed with no penalty.",
    category: "loans",
  },
  {
    id: "faq-015",
  ...
  // ── CARDS ────────────────────────────────────────────────────────────────────
  {
    ...
    answer:
      "Standard accounts have a £500 daily ATM limit. You can temporarily raise this to £1,000 for 24 hours in the app under Settings > Card Limits. Premium account holders have a £1,000 default limit. International ATM withdrawals are included in this limit. NovaBank ATMs are free - other ATM operators may charge their own fees.",
    category: "cards",
  },
  {
    id: "faq-017",
  ...
  {
    id: "faq-023",
    question: "Is my money protected at NovaBank?",
    answer:
      "Yes. NovaBank is authorised by the Prudential Regulation Authority and regulated by the Financial Conduct Authority. Your eligible deposits are protected up to £85,000 per person under the Financial Services Compensation Scheme (FSCS). Joint accounts are protected up to £170,000. This protection applies automatically - you do not need to register.",
    category: "security",
  },
  {
    id: "faq-024",
    question: "How does NovaBank protect me from fraud?",
    answer:
  ...
  {
    id: "faq-026",
    question: "What fees does NovaBank charge?",
    answer:
      "NovaBank Standard Current Account has no monthly fee. Premium Account costs £9.99 per month. UK transfers, direct debits, and standing orders are free on all accounts. CHAPS transfers cost £25. International SWIFT transfers cost £15 to £30. Paper statements cost £2 each - digital statements are free. There are no fees for using NovaBank ATMs.",
    category: "fees",
  },
  {
    id: "faq-027",
  ...
  {
    id: "faq-029",
    question: "How do I contact NovaBank customer support?",
    answer:
      "NovaBank support options: Chat assistant available 24 hours in the app and website. Phone 0800 123 4567 available 24 hours for urgent issues including lost cards and fraud. Secure message through online banking, response within 4 hours. Branch visits Monday to Friday 9am to 5pm, Saturday 9am to 1pm. For complaints, use the complaints form in the app or email complaints@novabank.co.uk.",
    category: "support",
  },
  {
    id: "faq-030",
    question: "What are NovaBank branch opening hours?",
    answer:
      "NovaBank branches are open Monday to Friday 9am to 5pm and Saturday 9am to 1pm. Closed Sundays and UK public holidays. ATMs are available 24 hours. Online banking and the app work around the clock. The chat assistant in the app handles most queries without needing to visit a branch.",
    category: "support",
  },
];
