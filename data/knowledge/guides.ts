 ...
 * NovaBank - Policies and how-to guides for ChromaDB RAG
 *
...
export const POLICY_DATA: PolicyEntry[] = [
  {
    ...
    category: "security",
    content:
      "NovaBank is authorised by the Prudential Regulation Authority and regulated by the Financial Conduct Authority (FCA). Customer deposits are protected by the Financial Services Compensation Scheme (FSCS). Individual accounts are protected up to £85,000 per person per banking group. Joint accounts are protected up to £170,000. Temporary high balances up to £1,000,000 are protected for 6 months following life events such as property sale, divorce settlement, or personal injury compensation. Protection is automatic - customers do not need to register or pay for it.",
  },
  {
    id: "pol-002",
  ...
  },
  {
    ...
    category: "accounts",
    content:
      "NovaBank can close an account with 60 days notice without providing a reason. Immediate closure is possible for suspected fraud, serious breach of terms, or legal obligation. Customers can close accounts at any time by contacting support, visiting a branch, or sending a secure message. Accounts with a remaining balance are settled by bank transfer or cheque within 5 business days. Fixed-term products cannot be closed early. ISAs can be transferred to another provider rather than closed to preserve the tax wrapper.",
  },
  // pol-005 "Data Privacy and GDPR" removed - it cited UK GDPR and the
  // Data Protection Act 2018, which don't apply under Irish/EU rules.
  // Needs a correct EU GDPR / Irish Data Protection Act 2018 replacement
  // written and reviewed before this topic goes back in the knowledge base.
];

export const GUIDE_DATA: GuideEntry[] = [
  {
    id: "guide-001",
    title: "How to switch your bank to NovaBank",
    category: "accounts",
    content:
      "Switching to NovaBank takes 7 working days using the Current Account Switch Service (CASS). Step 1: open a NovaBank account first if you do not have one. Step 2: in the app go to Account > Switch to NovaBank and enter your old bank details. Step 3: choose a switch date at least 7 working days away. CASS automatically moves all direct debits, standing orders, and incoming payments to your new account. Your old account closes on the switch date. Any payments that accidentally go to your old account are redirected for 3 years. The switch is free and guaranteed.",
  },
  {
    id: "guide-002",
    title: "How to apply for a mortgage with NovaBank",
    category: "mortgages",
    content:
      "Applying for a NovaBank mortgage has four stages. Stage 1 - Agreement in Principle: use the mortgage calculator to get an estimate, then request a Decision in Principle through the chat or app. This takes 24 hours and does not affect your credit score. Stage 2 - Full Application: once you have found a property, submit the full application with payslips (last 3 months), bank statements (last 3 months), P60 or SA302 for self-employed, and ID. Stage 3 - Valuation: we instruct a surveyor to value the property. Stage 4 - Offer: mortgage offer issued within 2 to 3 weeks of completed application. You then exchange contracts with your solicitor.",
  },
  {
    id: "guide-003",
  ...
  },
  {
    ...
    category: "credit",
    content:
      "To request a credit limit increase on your NovaBank credit card: go to Cards in the app, select your credit card, and tap Manage Limit > Request Increase. We will ask for your current income and employment status. A soft credit search is performed first - this does not affect your score. If eligible, the increase is applied within 24 hours. You can request an increase every 6 months. Limits above £15,000 require a full credit assessment. Your current limit is shown in the app under Cards > Credit Limit.",
  },
  {
    id: "guide-007",
    ...
    category: "transfers",
    content:
      "To send money internationally from NovaBank: go to Payments > International Transfer in the app. Enter the recipient name, IBAN, and SWIFT/BIC code (your recipient's bank provides these). Select the currency - we convert at the mid-market rate plus a margin. Standard transfers cost £15 to £30 depending on destination and take 1 to 3 business days. SWIFT transfers over £10,000 may require additional compliance checks. Check the exchange rate in the app before confirming - you see the exact amount the recipient will receive before you approve.",
  },
  {
    id: "guide-008",
