 ...
 * NovaBanк - Product sheets for ChromaDB RAG
 *
...
export const PRODUCT_DATA: ProductEntry[] = [
  ...
  },
  {
    ...
    type: "savings",
    content:
      "NovaBanк Easy Access Saver pays 4.5% AER variable interest. No lock-in period - withdraw anytime without penalty. Minimum opening balance £1. Maximum balance £500,000. Interest calculated daily, paid monthly. Rate is variable meaning it can go up or down. Manage entirely through the app or online banking. Good for: emergency funds, short-term savings, anyone who may need access to their money quickly.",
  },
  {
    id: "prod-004",
    ...
    type: "savings",
    content:
      "NovaBanк Fixed 1-Year Bond pays 5.1% AER fixed for 12 months. Minimum deposit £1,000, maximum £500,000. No withdrawals allowed during the term - your money is locked in for 12 months in exchange for the guaranteed fixed rate. Interest paid at maturity. On maturity your funds roll into Easy Access Saver automatically unless you instruct otherwise. Good for: money you will not need for a year that you want earning the best rate.",
  },
  {
    id: "prod-005",
  ...
  },
  {
    ...
    type: "loan",
    content:
      "NovaBanк personal loans from £1,000 to £25,000 over 1 to 7 years. Representative APR 6.9% for loans £7,500 to £25,000. Smaller amounts have higher representative APR. Instant decision in the app. Same-day funding if approved before 3pm. No early repayment penalties. Fixed monthly repayments throughout the term. Not for business purposes. You must be a NovaBanк account holder for at least 3 months to apply, or a new customer subject to full credit assessment.",
  },
  {
    id: "prod-010",
    ...
    type: "credit_card",
    content:
      "NovaBanк Cashback Credit Card earns 1% cashback on all UK spending and 0.5% on international spending. No annual fee. 0% interest on purchases for the first 3 months. After that, 22.9% APR representative variable. £5,000 credit limit for eligible applicants. Minimum monthly payment is the higher of 1% of balance or £25. Cashback paid to your NovaBanк current account monthly. Requires credit check. Best for: everyday spending with a free card.",
  },
  {
    id: "prod-011",
