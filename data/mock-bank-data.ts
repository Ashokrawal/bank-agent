...
export const PRODUCT_DATA = [
  ...
  },
  {
    ...
    requirements: ["Valid ID", "Proof of address", "UK resident aged 18+", "Credit check"],
    minimumDeposit: 10,
    monthlyFee: 9.99,
    metadata: { type: "product", category: "current" },
  },
  ...
  },
  {
    ...
    name: "Cash ISA",
    type: "isa",
    description: "A tax-free savings account. Save up to £20,000 per tax year with no tax on interest.",
    features: [
      "4.6% AER tax-free",
...
export const MOCK_USERS = [
  {
    ...
    password_hash: "$2a$10$mockhashjamescarter", // password: demo123
    name: "James Carter",
  ...
  },
  {
    ...
    password_hash: "$2a$10$mockhashsofiapatel",  // password: demo123
    name: "Sofia Patel",
  ...
  },
  {
    ...
    password_hash: "$2a$10$mockhashdemouser",    // password: demo123
    name: "Alex Demo",
...
export const MOCK_TRANSACTIONS = [
  ...
  { id: "txn-001", account_id: "acc-004", date: "2025-03-10", description: "TESCO SUPERSTORE", amount: -67.43, type: "debit", category: "groceries", balance_after: 2150.75 },
  { id: "txn-002", account_id: "acc-004", date: "2025-03-09", description: "SALARY - ACME CORP", amount: 2800.00, type: "credit", category: "income", balance_after: 2218.18 },
  { id: "txn-003", account_id: "acc-004", date: "2025-03-08", description: "NETFLIX.COM", amount: -17.99, type: "debit", category: "entertainment", balance_after: -581.82 },
  { id: "txn-004", account_id: "acc-004", date: "2025-03-07", description: "COSTA COFFEE", amount: -4.50, type: "debit", category: "food", balance_after: -563.83 },
  { id: "txn-005", account_id: "acc-004", date: "2025-03-06", description: "AMAZON PRIME", amount: -8.99, type: "debit", category: "entertainment", balance_after: -559.33 },
  { id: "txn-006", account_id: "acc-004", date: "2025-03-05", description: "BP PETROL STATION", amount: -62.00, type: "debit", category: "transport", balance_after: -550.34 },
  { id: "txn-007", account_id: "acc-004", date: "2025-03-03", description: "TFL TRAVEL", amount: -35.60, type: "debit", category: "transport", balance_after: -488.34 },
  { id: "txn-008", account_id: "acc-004", date: "2025-03-01", description: "RENT - LANDLORD", amount: -950.00, type: "debit", category: "housing", balance_after: -452.74 },
  { id: "txn-009", account_id: "acc-004", date: "2025-02-28", description: "MARKS & SPENCER", amount: -43.21, type: "debit", category: "shopping", balance_after: 497.26 },
  { id: "txn-010", account_id: "acc-004", date: "2025-02-26", description: "TRANSFER FROM SAVINGS", amount: 500.00, type: "credit", category: "transfer", balance_after: 540.47 },
  { id: "txn-011", account_id: "acc-004", date: "2025-02-25", description: "SPOTIFY", amount: -11.99, type: "debit", category: "entertainment", balance_after: 40.47 },
  { id: "txn-012", account_id: "acc-004", date: "2025-02-24", description: "BOOTS PHARMACY", amount: -22.50, type: "debit", category: "health", balance_after: 52.46 },
  { id: "txn-013", account_id: "acc-004", date: "2025-02-20", description: "DIRECT DEBIT - COUNCIL TAX", amount: -145.00, type: "debit", category: "bills", balance_after: 74.96 },
  { id: "txn-014", account_id: "acc-004", date: "2025-02-18", description: "DIRECT DEBIT - GAS & ELEC", amount: -89.00, type: "debit", category: "bills", balance_after: 219.96 },
  { id: "txn-015", account_id: "acc-004", date: "2025-02-10", description: "SALARY - ACME CORP", amount: 2800.00, type: "credit", category: "income", balance_after: 308.96 },
  // James Carter transactions — acc-001
  { id: "txn-016", account_id: "acc-001", date: "2025-03-10", description: "WAITROSE SUPERMARKET", amount: -112.30, type: "debit", category: "groceries", balance_after: 4823.50 },
  { id: "txn-017", account_id: "acc-001", date: "2025-03-09", description: "SALARY - TECH LTD", amount: 4200.00, type: "credit", category: "income", balance_after: 4935.80 },
  { id: "txn-018", account_id: "acc-001", date: "2025-03-05", description: "MORTGAGE PAYMENT", amount: -1450.00, type: "debit", category: "housing", balance_after: 735.80 },
];
