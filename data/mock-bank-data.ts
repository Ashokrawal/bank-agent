 ...
 * NovaBank — fictional bank for demo purposes
 */
...
export const FAQ_DATA = [
  {
    ...
    answer:
      "NovaBank branches are open Monday to Friday 9:00 AM – 5:00 PM, and Saturday 9:00 AM – 1:00 PM. We are closed on Sundays and public holidays. Our ATMs are available 24/7. Online and mobile banking is available around the clock.",
    category: "hours",
  ...
  },
  {
    ...
    answer:
      "To open a NovaBank account you need: (1) Primary ID — passport, national ID card, or driver's licence. (2) Proof of address — utility bill, council tax letter, or bank statement, all dated within the last 3 months. (3) Tax/NI number. (4) A selfie for identity verification. We do not accept expired documents.",
    category: "accounts",
    metadata: { type: "faq", category: "accounts" },
  },
  {
  ...
  },
  {
    ...
    answer:
      "NovaBank offers the following savings rates: Easy Access Saver — 4.5% AER variable. Fixed 1-Year Bond — 5.1% AER fixed. Fixed 2-Year Bond — 5.3% AER fixed. Junior ISA — 4.8% AER tax-free. Cash ISA — 4.6% AER tax-free. Rates are correct as of 2025 and may change. AER stands for Annual Equivalent Rate.",
    category: "products",
  ...
  },
  {
    ...
    answer:
      "NovaBank Standard Current Account has no monthly fee. Our Premium Account is £9.99/month and includes worldwide travel insurance, breakdown cover, and fee-free foreign transactions. Business accounts start from £7.50/month. There are no fees for UK transfers, direct debits, or standing orders on any account.",
    category: "fees",
  ...
  },
  {
    ...
    answer:
      "Yes. NovaBank is authorised by the Prudential Regulation Authority and regulated by the Financial Conduct Authority. Your eligible deposits are protected up to £85,000 per person under the Financial Services Compensation Scheme (FSCS). Joint accounts are protected up to £170,000.",
    category: "security",
...
export const PRODUCT_DATA = [
  ...
  },
  {
    ...
    requirements: ["NovaBank current account required", "Aged 18+"],
    minimumDeposit: 1,
    monthlyFee: 0,
